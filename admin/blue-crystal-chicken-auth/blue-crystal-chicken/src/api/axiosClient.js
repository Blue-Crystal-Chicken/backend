...
// "??" (non "||"): se VITE_API_URL è definita ma vuota (build Docker dietro
// nginx reverse-proxy) resta "" → axios usa URL relative same-origin (/api/...).
// In sviluppo locale la variabile è assente → fallback su localhost:8080.
