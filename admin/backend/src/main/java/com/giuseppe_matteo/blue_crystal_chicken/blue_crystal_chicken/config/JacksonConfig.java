 ...
 * AuthEntryPointJwt) usano però il classico Jackson 2
 * (com.fasterxml.jackson.databind.ObjectMapper), per cui non esiste un bean.
 * Questo @Bean lo registra esplicitamente.
 */
@Configuration
