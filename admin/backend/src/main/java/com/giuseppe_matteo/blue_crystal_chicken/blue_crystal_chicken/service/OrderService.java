...
public class OrderService {
    ...
    public List<OrderEntity> findByLocation(Long locationId) {
        return orderRepository.findByLocation_Id(locationId);
    }

    public List<OrderEntity> findByLocationAndDateRange(Long locationId, LocalDateTime from, LocalDateTime to) {
        return orderRepository.findByLocation_IdAndCreatedAtBetween(locationId, from, to);
    }

    public BigDecimal getRevenueByLocation(Long locationId, LocalDateTime from, LocalDateTime to) {
        BigDecimal total = orderRepository.sumTotalByLocationBetween(locationId, from, to);
        return total != null ? total : BigDecimal.ZERO;
    }
    ...
    public OrderEntity update(Long id, UpdateOrderRequest request) {
        ...
        // Aggiornamento articoli (usato dalla Cassa): ricostruisce le righe ordine.
        // Questo backend modella le righe solo con product/offer (no menu/ingredienti).
