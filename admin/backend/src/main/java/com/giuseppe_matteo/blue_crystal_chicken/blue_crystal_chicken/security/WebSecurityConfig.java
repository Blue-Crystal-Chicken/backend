    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(
                Arrays.asList(
                        ...
                        "http://127.0.0.1:8081",
                        // Container Docker (frontend serviti da nginx) — admin, manager, cucina, tabellone
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.cors(cors -> cors.configurationSource(corsConfigurationSource()))
                ...
                .authorizeHttpRequests(auth -> auth.requestMatchers("/api/auth/**").permitAll()
                        ...
                        // Token-stazione di una sede: solo Admin (DEVE precedere il GET pubblico /api/locations/**)
                        ...
                        // (JWT ADMIN oppure token-stazione della sede) la fa OrderController.updateStatus.
                        ...
                        // FASE 2 — Manager: il Manager puo' creare/leggere RICHIESTE.
                        // Queste regole DEVONO precedere quelle generiche /api/** sotto.
                        // (approve/reject restano riservate all'ADMIN via @PreAuthorize)
                        ...
                        // Upload immagini per le richieste (Manager carica, poi imgPath nel payload)
                        .requestMatchers(HttpMethod.POST, "/api/uploads/**").hasAnyRole("MANAGER", "ADMIN")

                        // Offerte: gestite DIRETTAMENTE dal Manager (oltre che dall'Admin)
                        ...
                        // Scorte di sede: il Manager gestisce le scorte della propria sede
