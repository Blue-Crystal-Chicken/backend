...
public class UserDetailsServiceImpl implements UserDetailsService {
    ...
    // accede alla 'location' LAZY dell'utente. Il filtro JWT gira prima dell'open-in-view,
    // quindi senza transazione un MANAGER (con sede) causerebbe LazyInitializationException → 401.
    @Override
