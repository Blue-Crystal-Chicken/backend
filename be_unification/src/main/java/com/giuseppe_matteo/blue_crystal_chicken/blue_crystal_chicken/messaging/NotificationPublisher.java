 ...
 * Resiliente: se il broker non è raggiungibile l'errore viene loggato ma NON
 * propagato, così le operazioni applicative non falliscono.
 */
@Component
...
public class NotificationPublisher {
    ...
    // Helper compatto (notifica globale)
